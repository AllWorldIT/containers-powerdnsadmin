...
CONFIG_FILE = "/etc/powerdnsadmin/config.env"

# Check config file exists and is a file
if not os.path.exists(CONFIG_FILE):
    raise RuntimeError(f"Configuration file '{CONFIG_FILE}' does not exist")
if not os.path.isfile(CONFIG_FILE):
    raise RuntimeError(f"Configuration file '{CONFIG_FILE}' is not a file")
...
legal_envvars_dict = ("SQLALCHEMY_ENGINE_OPTIONS",)
